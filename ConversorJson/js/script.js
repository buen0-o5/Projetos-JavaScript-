const convertForm = document.querySelector("#converterForm");
const converterInput = document.querySelector(".converterInput");
const jsonTocsvBtn = document.querySelector("#jsonTocsv");
const csvTojsonBtn = document.querySelector("#csvTojson");
